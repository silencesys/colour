<?php
    ...
    $invert  = color_inverse($colors['HEXcolor']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Colorizer<?php echo " - ",$mycolor; ?></title>
    <!-- META -->
    ...
    <style>
        /* h1, h1 a, .findMyColor input[type="text"], .mainNavigation, .mainNavigation a, .randomColor h2, .randomColor .btnGroup .fa, footer
        {color: <?php  echo color_inverse($invert) ?>;}
        .findMyColor input[type="text"] {border-color: <?php  echo color_inverse($invert) ?>;} */
        p a {color: <?php  echo $mycolor; ?>;}
        p a:hover, h1 a:hover, .mainNavigation a:hover {color: <?php  echo color_inverse($mycolor) ?>;}
        .findMyColor input[type="submit"]:hover {background: <?php  echo color_inverse($mycolor) ?>; border-color: <?php  echo color_inverse($mycolor) ?>;}
        .findMyColor input[type="text"]:focus {border-color: <?php  echo color_inverse($mycolor) ?>;}
        .randomColor .switchColor .btnGroup:hover .fa {color: <?php  echo color_inverse($mycolor) ?>;}
    </style>
</head>
<!-- HEAD END -->
<body style="background: <?php echo $mycolor; ?>">
<section class="colorizer">
    ...
    <section class="randomColor">
        ...
        <form method="get" action="<?php echo $action ?>" class="switchColor">
            <div class="btnGroup">
                <input type="hidden" value="<?php PrintRcolor(); ?>">
